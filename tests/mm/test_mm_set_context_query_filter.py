...
from tests.mm.steps import open_auth_page, open_mm_main_page, open_mm_search_report, set_context_query_filter, sign_in


@allure.epic('SPPR AMIPM')
@allure.title('Ввод фильтра "Контекстный запрос"')
@pytest.mark.parametrize('browser', CLIENT_BROWSERS)
@pytest.mark.parametrize('device_type', CLIENT_DEVICE_TYPE)
def test_mm_set_context_query_filter(
